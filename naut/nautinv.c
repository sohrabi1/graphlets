...
static __declspec(thread) int fuzz1[] = {037541,061532,005257,026416};
static __declspec(thread) int fuzz2[] = {006532,070236,035523,062437};
...
#if MAXN
static __declspec(thread) set workset[MAXM];
static __declspec(thread) shortish workshort[MAXN+2];
static __declspec(thread) set ws1[MAXM], ws2[MAXM];
static __declspec(thread) shortish vv[MAXN],ww[MAXN];
static __declspec(thread) set w01[MAXM],w02[MAXM],w03[MAXM],w12[MAXM],w13[MAXM],w23[MAXM];
static __declspec(thread) set pt0[MAXM],pt1[MAXM],pt2[MAXM];
static __declspec(thread) set wss[MAXCLIQUE-1][MAXM];
#else
